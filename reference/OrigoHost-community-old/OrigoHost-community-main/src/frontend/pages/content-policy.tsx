        ...
        <section className="bg-slate-900 text-white py-20">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-300">
              Guidelines governing the creation, publication, and moderation of all content across
              the OrigoHOST ecosystem.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p className="font-semibold text-slate-900">
                ...
                original, and free of undisclosed AI generation. Spam, malicious code, and
                plagiarized materials are strictly prohibited and will result in immediate removal.
              </p>
              ...
              <div className="grid gap-12 mt-12">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                  ...
                  <p>
                    All content must be original. If Generative AI tools (such as ChatGPT, Claude,
                    or Gemini) are used to assist in the writing process, the final output must be
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                  ...
                  <p>
                    ...
                    malware, phishing sites, or unverified executables will result in an immediate
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                  ...
                  <p>
                    ...
                    accepted. Code snippets must be tested and functional at the time of
                    publication.
                  </p>
                </div>
              </div>
