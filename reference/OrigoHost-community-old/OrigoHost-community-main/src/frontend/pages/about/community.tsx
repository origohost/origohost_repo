    ...
    <PageShell title="The OrigoHOST Community">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <div className="prose prose-lg text-slate-700">
          ...
          <p>
            We operate local chapters across major Indian technical institutions, including IITs and
            NITs. The community drives grassroots innovation by providing free access to cloud
            credits, mentorship from industry experts, and a direct pipeline to careers in software
            engineering.
          </p>
        </div>
      </div>
