...
async function seed() {
  ...
  const { data: event, error: eventErr } = await supabase.from('events_v2').upsert({
    id: eventId,
    ...
    short_description: "Learn cybersecurity fundamentals, ethical hacking concepts, responsible security practices, and real-world career opportunities through an interactive live session.",
...
Linux, Kali Linux, Windows Security, Wireshark, Burp Suite, Nmap, OWASP, Metasploit, Google Dorking, Password Managers, Firewalls, VPN, Virtual Machines.`,
    ...
    registration_link: "https://unstop.com/o/2HNSbPd?lb=3fjmXvr8&utm_medium=Share&utm_source=imtarunchaudhary&utm_campaign=Workshops",
    price: 0,
    category: "Knowledge Sharing Series",
    is_published: true,
    certificate_enabled: true,
    seo_metadata: {
      tags: ["Cybersecurity", "Ethical Hacking", "Information Security", "Network Security", "OWASP", "Linux", "Security", "Vulnerability Assessment", "Penetration Testing", "Cyber Awareness", "Google Meet", "Online Webinar", "OrigoHOST"],
      badges: ["Knowledge Sharing Series", "Episode 03", "Upcoming", "Free", "Limited Seats", "Certificate", "Online"]
    }
  }).select().single();
