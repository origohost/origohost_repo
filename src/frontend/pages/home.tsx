      ...
      <section id="participate" className="relative bg-white py-24 border-b border-slate-100">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <span className="text-xs sm:text-xs font-bold uppercase tracking-widest text-blue-600 bg-blue-50 px-3.5 py-1.5 rounded-full">
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {PARTICIPATION_WAYS.map((way) => (
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-bold text-slate-800">{way}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {EVENT_FORMATS.map((ef) => (
              ...
              >
                <span className="text-sm font-mono font-bold text-blue-400 block mb-2">
                  {ef.name}
                </span>
                <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{ef.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="matrix" className="bg-slate-50 py-24 border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-16">
            <span className="text-xs font-bold uppercase tracking-widest text-blue-600 bg-blue-100 px-3.5 py-1.5 rounded-full">
              TAXONOMY ENGINE
            </span>
            <h2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight">
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm border border-slate-200">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                {TECH_DOMAINS.map((domain) => (
                  <div
                    key={domain}
                    className="rounded-xl bg-slate-50 p-3 text-xs sm:text-sm font-semibold text-slate-800 border border-slate-200/80"
                  >
                    {domain}
                  </div>
                ))}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50/50 p-8 shadow-sm flex flex-col justify-between">
              ...
              <Button
                asChild
                className="w-full rounded-full bg-blue-600 hover:bg-blue-700 font-bold text-sm"
              >
                <Link to="/knowledge">
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50/50 p-8 shadow-sm flex flex-col justify-between">
              ...
              <Button
                asChild
                variant="outline"
                className="w-full rounded-full border-slate-300 font-bold text-sm"
              >
