...
export default function HeroSection() {
  return (
    <section id="hero" data-testid="hero" className="relative overflow-hidden bg-[#050505] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-32 pb-12 sm:pt-40 sm:pb-20 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <span className="text-xs text-red-400 font-medium">Pioneering hosting & platform engineering in India</span>
          </motion.div>
          ...
          >
            India's Leading<br />
            <span className="text-[#0066ff] drop-shadow-[0_0_15px_rgba(0,102,255,0.3)]">Hosting</span> Community
          </motion.h1>
          ...
          >
            Uniting developers, learners, and innovators to connect, collaborate, and create the future of technology together.
          </motion.p>
          ...
          >
            ...
            >
              <Link to="/community/events">
                Explore Events <Calendar className="ml-2 h-4 w-4 transition-transform group-hover:-rotate-12 group-hover:-translate-y-1" />
              </Link>
            </Button>
        ...
        <div className="relative min-h-[400px] lg:min-h-[500px] flex items-center justify-center mt-12 lg:mt-0">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none animate-orbit" style={{ animationDuration: '35s' }}>
            ...
            <Tilt>
                <div className="relative z-10 w-[280px] h-[280px] sm:w-[400px] sm:h-[400px] lg:w-[450px] lg:h-[450px] flex items-center justify-center transition-transform duration-500 hover:scale-110">
                    ...
                    <img src="/logo-transparent.png" alt="OrigoHOST" className="relative z-10 w-full h-full object-contain drop-shadow-[0_0_20px_rgba(37,99,235,0.4)]" />
                </div>
            </Tilt>
            ...
            >
                <div className="flex items-center gap-3 bg-[#111]/80 backdrop-blur-md border border-white/10 px-4 py-2.5 rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.5)]">
                    ...
                    <div>
                        <p className="text-[13px] font-bold text-white leading-tight tracking-wide">Learn</p>
            ...
            >
                <div className="flex items-center gap-3 bg-[#111]/80 backdrop-blur-md border border-white/10 px-4 py-2.5 rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.5)]">
                    ...
                    <div>
                        <p className="text-[13px] font-bold text-white leading-tight tracking-wide">Build</p>
            ...
            >
                <div className="flex items-center gap-3 bg-[#111]/80 backdrop-blur-md border border-white/10 px-4 py-2.5 rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.5)]">
                    ...
                    <div>
                        <p className="text-[13px] font-bold text-white leading-tight tracking-wide">Connect</p>
      ...
      <div className="relative bg-white z-20 pb-16">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            {STATS.map((s, i) => {
                ...
                return (
                <div key={s.label} className="w-[85vw] shrink-0 snap-center md:w-auto md:shrink md:flex-1">
