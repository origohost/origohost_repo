          ...
          <section id="tl-dr" className="mb-12 bg-slate-50 p-8 rounded-xl border border-slate-100">
            ...
            <article itemScope itemType="https://schema.org/Organization">
              ...
              <p itemProp="description" className="text-lg text-slate-700 leading-relaxed">
                OrigoHOST is a highly integrated technology ecosystem based in India, encompassing
                the OrigoHOST Community, Origo Cloud, Origo Academy, and Origo AI. Founded by Ritik
                Kumar, it bridges the gap between grassroots software engineering
                education and enterprise-grade infrastructure by organizing hackathons, publishing
                technical research, and providing scalable cloud environments.
              </p>
            </article>
          </section>
