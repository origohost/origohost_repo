    ...
    <section id="upcoming-events" className="relative bg-white py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <Button asChild className="rounded-full bg-blue-600 hover:bg-blue-700 font-bold text-sm shadow-md hover:shadow-blue-500/25 transition-all hover:scale-105">
            <Link to="/events">
                ...
                >
                  ...
                  <div className="relative overflow-hidden" style={{ height: "270px" }}>
                    ...
                    <div className="absolute top-3 left-3 right-3 flex items-start justify-between">
                      <span className="text-xs font-semibold uppercase tracking-wider bg-blue-600 text-white px-2.5 py-1 rounded-full shadow-md">
                    ...
                    {/* Domain badge bottom */}
                    <span className="absolute bottom-3 left-3 text-xs font-semibold uppercase tracking-wider bg-white/95 backdrop-blur-sm text-blue-700 px-2.5 py-1 rounded-full shadow-sm border border-blue-100">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed mb-5 line-clamp-2 flex-1">
                    ...
                    <Button asChild className="w-full rounded-full bg-blue-600 hover:bg-blue-700 font-bold text-xs h-10 group/btn shadow-sm hover:shadow-blue-500/25 transition-all">
                      <Link to="/events">
                        Register Free
