    ...
    <section id="projects-showcase" className="bg-slate-50 py-24 border-b border-slate-200">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
          <div>
            <span className="text-xs font-semibold uppercase tracking-wider text-emerald-700 bg-emerald-100 px-3.5 py-1.5 rounded-full border border-emerald-200">
              {data.eyebrow}
            </span>
            ...
            >
              ...
              <div className="relative overflow-hidden" style={{ height: "220px" }}>
                ...
                <div className="absolute bottom-3 left-3 flex items-center gap-2">
                  <span className="text-xs font-semibold uppercase tracking-wider bg-white/90 backdrop-blur-sm text-slate-700 px-2.5 py-1 rounded-full shadow-sm">
                    {project.techDomain}
                  </span>
                  <span className="text-xs font-semibold uppercase tracking-wider bg-emerald-600/90 backdrop-blur-sm text-white px-2.5 py-1 rounded-full shadow-sm">
                    {project.industry}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-6 flex-1">{project.desc}</p>
                {project.demoUrl && (
                  <a
                    href={project.demoUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center w-full h-10 rounded-full border border-slate-300 bg-white text-slate-700 text-xs font-semibold hover:border-blue-400 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200"
                  >
