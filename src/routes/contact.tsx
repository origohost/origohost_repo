...
export const Route = createFileRoute("/contact")({
  head: () =>
    buildSeo({
      ...
      description:
        "Have a question, partnership idea, collaboration proposal, or simply want to connect with the OrigoHOST team?",
      path: "/contact",
    }),
    ...
    <div className="relative min-h-screen bg-white text-slate-900 pt-28 pb-20 selection:bg-blue-600 selection:text-white">
      ...
      <section className="bg-slate-900 text-white py-20 px-6 lg:px-8 border-b border-slate-800">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-4 text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Have a question, partnership idea, collaboration proposal, or simply want to connect?
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 lg:px-8 max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 space-y-6">
          <h2 className="text-2xl font-black text-slate-900">Contact Channels</h2>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
            ...
            <p className="text-xs text-slate-600 mb-3">
              Questions about OrigoHOST and community activities.
            </p>
            <a
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
            ...
            <p className="text-xs text-slate-600 mb-3">
              Collaborate with OrigoHOST on events and cohorts.
            </p>
            <a
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
            ...
            <p className="text-xs text-slate-600 mb-3">Event sponsorships and hosting inquiries.</p>
            <a
              href="mailto:origohostscommunity@gmail.com?subject=Events"
              className="text-xs font-bold text-slate-900 hover:text-blue-600"
            >
              origohostscommunity@gmail.com
            </a>
          ...
          {submitted ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-slate-600">
                Thank you for reaching out. The OrigoHOST team will reply within 24 hours.
              </p>
            </div>
          ) : (
